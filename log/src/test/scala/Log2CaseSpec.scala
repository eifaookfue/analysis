...
class Log2CaseSpec extends FlatSpec {
  ...
  def fixture =
    new {
      val logs = List(
        ...
        "2019-12-16 12:06:46.391 [OMS:INFO ][TradeSheet][New Split    - Parent Order]Dialog opend.[main][j.c.n.n.o.r.p.d.s.n.NewSplitDialog]",
